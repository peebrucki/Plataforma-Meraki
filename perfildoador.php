            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    ...
                    <div class="home__data">
                         <h2 class="section-title-center">Dados <br> Doador</h2>
                         <h3>Para ver seus dados atualizados será necessário fazer logout e se logar novamente!<br></h3><br>
                        <p class="share__description">
                          <?php
                              echo "Nome: " . $_SESSION['nome_doador'] . "<br>";
                              echo "E-mail: " . $_SESSION['email_doador'] . "<br>";
                              echo "Telefone: " . $_SESSION['telefone_doador'] . "<br>";
                              echo "CEP: " . $_SESSION['cep_doador'] . "<br>";
                              echo "CPF: " . $_SESSION['cpf_doador'] . "<br>"; 
                              echo "<a href='alterardoador.php?id_doador=" . $_SESSION['id_doador'] . "'>Editar</a><br><hr>";
                            ?>
                        </p>
                 ...
                 <div class="home__container bd-container bd-grid">
                    ...
                    <div class="home__data">
                        ...
                        <?php
                          echo "<a href='respostadoador.php?nome_doador=" . $_SESSION['nome_doador'] . "'>Resposta</a><br><hr>";
                          ?>                       
                    </div>   
                </div>
            </section>
