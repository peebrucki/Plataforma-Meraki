...
if(mysqli_affected_rows($mysqli)){
	echo "<script> alert('Alterações Feitas com Sucesso!');location.href=\"../dadosdoadoradm.php\";</script>";
}else{
	echo "<script> alert('Ocorreu um Erro! O Usuario NÃO foi Editado');location.href=\"../dadosdoadoradm.php\";</script>";
}