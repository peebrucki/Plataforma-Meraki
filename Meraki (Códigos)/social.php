...
?>
    ...
    <body>
        ...
        <main class="l-main">
            ...
            <!--========== ACCESSORIES ==========-->
            <center><section class="accessory section bd-container" id="accessory">
               <h2 class="section-title">ONG´s Sociais <br> </h2>
        ...
        $result_usuarios = "SELECT * FROM ong WHERE categoria_ong = 'social' LIMIT $inicio, $qnt_result_pg";
 ...
 <footer class="footer section">
        ...
        $result_pg = "SELECT COUNT(id_ong) AS num_result FROM ong WHERE categoria_ong = 'social'";
        ...
        $max_links = 2;
        echo "<a href='social.php?pagina=1'>Primeira</a> ";
        
        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
            if($pag_ant >= 1){
                echo "<a href='social.php?pagina=$pag_ant'>$pag_ant</a> ";
            }
        }
        ...
        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
            if($pag_dep <= $quantidade_pg){
                echo "<a href='social.php?pagina=$pag_dep'>$pag_dep</a> ";
            }
        }
        
        echo "<a href='social.php?pagina=$quantidade_pg'>Ultima</a>";
