...
?>
    ...
    <body>
        ...
        <main class="l-main">
            ...
            <center><section class="accessory section bd-container" id="accessory">
               <h2 class="section-title">ONG´s para Animais <br> </h2>
        ...
        $result_usuarios = "SELECT * FROM ong WHERE categoria_ong = 'animais' LIMIT $inicio, $qnt_result_pg";
 ...
 <footer class="footer section">
        ...
        $result_pg = "SELECT COUNT(id_ong) AS num_result FROM ong WHERE categoria_ong = 'animais'";
